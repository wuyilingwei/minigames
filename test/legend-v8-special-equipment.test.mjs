...
for (const text of ['makeEmergencyShield', 'name:"战术护盾"', '【战术护盾】进战触发', 'part:"accessory"', 'emergencyCharges', 'function triggerEmergencyShield', 'function emergencyShieldValue(item)']) {
