...
if (cassandri.includes('<h3>难度装备位</h3>')) {
  throw new Error('Difficulty-unlocked equipment slots must not be shown as a shop item.');
}
if (!/<h3>潘多拉之盒<\/h3>[\s\S]*<h3>大记忆消失术<\/h3>/.test(cassandri)) {
